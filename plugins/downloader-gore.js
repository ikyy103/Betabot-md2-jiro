...
use *${usedPrefix + command} girl jump*`)
            try {
                m.reply(wait)
...
use *${usedPrefix + command} https://seegore.com/19-year-old-girl-stabs-her-rapist-17-times/*`)
            try {
                m.reply(wait)
...
handler.help = ["goredl", "goresearch"]
handler.command = ['goredl', 'goresearch']
