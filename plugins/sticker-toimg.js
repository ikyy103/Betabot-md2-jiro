Berikut adalah script yang telah diperbarui untuk menambahkan pesan bahwa proses konversi sedang berlangsung:
...
let handler = async (m, { conn, usedPrefix, command }) => {
  ...
  try {
    // Menginformasikan bahwa proses konversi sedang berlangsung
    m.reply('Sabarr......\n\n> Proses konversi sedang berlangsung, mohon tunggu...');
