...
let handler = async (m, { conn, text }) => {
  ...
  if (!mentionedJid) {
    throw 'Tag pengguna yang ingin ditambahkan xp-nya. Contoh: .addxp @user 10';
  }
  ...
  conn.reply(m.chat, `Berhasil menambahkan ${pointsToAdd} XP untuk @${mentionedJid.split('@')[0]}.`, m, {
